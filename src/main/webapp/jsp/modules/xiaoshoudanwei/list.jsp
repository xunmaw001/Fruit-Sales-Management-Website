...
<body>
		...
		<div id="content">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">销售单位管理</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item">销售单位管理</li>
								<li class="breadcrumb-item active">销售单位列表</li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">销售单位列表</h3>							
							<div class="table-responsive mb-3">
								<div class="col-sm-12">
																																									<label>
												单位
												<input type="text" id="danweiSearch" class="form-control form-control-sm" placeholder="" aria-controls="tableId">
											</label>
	...
	<script>
		...
		function search(){
			searchForm = { key: ""};
													if($('#danweiSearch').val() != null && $('#danweiSearch').val() != ''){
					searchForm.danwei ="%" +  $('#danweiSearch').val() + "%";
				}
        ...
        function getDataList() {
			http("xiaoshoudanwei/page","GET",{
				page: pageIndex,
				limit: pageSize,
				sort: sortColumn,
				order: sortOrder,
																						danwei : searchForm.danwei,	
																		},(res)=>{
				if(res.code == 0){
					clear();
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("xiaoshoudanwei/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						getDataList();		
						alert('删除成功');
					}
		...
		function getSum(colName){
			http("xiaoshoudanwei"+colName,"GET",{
		...
		function crossTable(id,crossTableName){
			...
			window.sessionStorage.setItem('crossTableName',"xiaoshoudanwei");
