		...
		<div id="content">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">编辑会员分析</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item">会员分析管理</li>
								<li class="breadcrumb-item active">编辑会员分析</li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">会员分析信息</h3>
								...
								<div class="form-row">
									<input id="updateId" name="id" type="hidden">
										...
										<input id="dianhua" name="dianhua" class="form-control"  value="" readonly>
											...
											<div class="form-group col-md-6">
										<label>住址</label>
										<input id="zhuzhi" name="zhuzhi" class="form-control"  value="" readonly>
									</div>
											<div class="form-group col-md-6">
										<label>购买时间</label>
										<div id="goumaishijianDate" class="input-append date form_datetime">
											...
											<div class="form-group col-md-6">
										<label>购买次数</label>
										<input id="goumaicishu" name="goumaicishu" class="form-control" placeholder="购买次数">
									</div>
	...
	<script type="text/javascript" charset="utf-8" src="${pageContext.request.contextPath}/resources/js/datetimepicker/bootstrap-datetimepicker.min.js"></script>
				...
				http("follow/yonghu/zhanghao","GET",{
					...
					if(res.code == 0){
									...
									$("#dianhua").val(res.data.dianhua);
																												...
																												if(res.data != null && res.data.zhuzhi != null){
		  ...
		  beforeCreate: function(){
			  var id = window.sessionStorage.getItem("id");
				if(id != null && id != "" && id != "null"){
					$.ajax({ 
		                type: "GET",
		                url: baseUrl + "huiyuanfenxi/info/" + id,
		...
		function submit() {
			if(validform() ==true && compare() == true){
				...
				httpJson("huiyuanfenxi/"+urlParam,"POST",data,(res)=>{
					if(res.code == 0){
		...
		function getDetails() {
			...
			if(id != null && id != "" && id != "null"){
				updateId = id;
				window.sessionStorage.removeItem('id');
				http("huiyuanfenxi/info/" + id,"GET",{},(res)=>{
					if(res.code == 0){
						ruleForm = res.data
						// 是/否下拉框回显
						setSelectOption();
		...
		function dataBind(){
			$("#updateId").val(ruleForm.id);	
																...
																$("#goumaicishu").val(ruleForm.goumaicishu);	
									}		
		//图片显示
		function showImg(){
																																																													}		
					...
					if(res.code == 0){
						...
						$('#updateId').val(crossTableId);
								...
								$('#goumaishijianFileName').val(res.data.goumaishijian)
												...
												if(res.data != null && res.data != '' && res.data.goumaicishu != null && res.data.goumaicishu != ''){

															$("#goumaicishu").val(res.data.goumaicishu);
													}
											}
				});  
            }
