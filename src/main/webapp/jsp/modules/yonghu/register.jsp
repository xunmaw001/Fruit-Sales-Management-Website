                        ...
                        <div class="form d-flex align-items-center">
                            <div class="content">
                                <form id="registerForm" action="" method="post" class="form-validate">
									<input type="text" placeholder="请输入账号" name="zhanghao" class="input-material">
									...
									<input type="text" placeholder="请输入电话" name="dianhua" class="input-material">
									<input type="text" placeholder="请输入邮箱" name="youxiang" class="input-material">
									<input type="text" placeholder="请输入住址" name="zhuzhi" class="input-material">
