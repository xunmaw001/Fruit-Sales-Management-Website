		...
		<script>
			...
			layui.use(['layer', 'element', 'carousel', 'http', 'jquery', 'form', 'upload', 'laydate','tinymce'], function() {
					...
					if (res.data.list.length > 0) {
						...
						carousel.render({
							...
							indicator: "none"
                																								...
                																								http.request(`option/shuiguoleibie/leibie`,'get',{},(res)=>{
					...
					error: function() {
						...
						layer.msg("请求接口异常", {
							...
							icon: 5
																...
																http.request(`option/xiaoshoudanwei/danwei`,'get',{},(res)=>{
				...
				form.on('submit(*)', function(data) {
					...
					// 提交数据
					http.requestJson('shuiguoxinxi' + '/add', 'post', data, function(res) {
					 	layer.msg('提交成功', {
					 		time: 2000,
					 		icon: 6
					 	}, function() {
