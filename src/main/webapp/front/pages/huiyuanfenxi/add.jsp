		...
		<div id="app">
			...
			<div class="data-add-container">
				...
				<form class="layui-form layui-form-pane" lay-filter="myForm">
						...
						<div class="layui-input-block">
							<input v-model="detail.goumaicishu" type="text" name="goumaicishu" id="goumaicishu" autocomplete="off" class="layui-input">
						</div>
					</div>
				...
				form.on('select(zhanghao)', (data) => {
					...
					http.request('follow/yonghu/zhanghao', 'get', {
						columnValue: data.value
																								...
																								jquery("#zhuzhi").val(res.data.zhuzhi)
																																									})
				});
                																																																				laydate.render({
					elem: '#goumaishijian',
				...
				form.on('submit(*)', function(data) {
                    ...
                    // 数据校验
                        ...
                        return false
                                                                                                                                                                                    					                                                                                                                                                                					                                                                                                                                                                					                                                                                                                                                                					                                                                                                                                                                					                                                                                                                                                                					                                                                                                                                                                					                                        ...
                                                                                                                                                                                    					                                                                                                                                                                					                                                                                                                                                                					                                                                                                                                                                					                                                                                                                                                                					                                                                                                                                                                					                                                                                                                                                                					                                        if(!isIntNumer(data.goumaicishu)){
                        layer.msg('购买次数应输入整数', {
							time: 2000,
							icon: 5
						});
					...
					// 提交数据
					http.requestJson('huiyuanfenxi' + '/add', 'post', data, function(res) {
					 	layer.msg('提交成功', {
					 		time: 2000,
					 		icon: 6
					 	}, function() {
